...
class Mobil extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('plat_no, pemilik, warna, tipe', 'required'),
			array('plat_no', 'length', 'max'=>10),
			array('pemilik', 'length', 'max'=>40),
			array('warna', 'length', 'max'=>15),
			array('tipe', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('plat_no, pemilik, warna, tipe', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('plat_no',$this->plat_no,true);
